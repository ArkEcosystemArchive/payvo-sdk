...
describe("ClientService", () => {
	test("#transactions", async () => {
		nock("https://proxy.nanos.cc/").post("/proxy").reply(200, require(`../test/fixtures/client/transactions.json`));
	...
	test("#wallet", async () => {
		nock("https://proxy.nanos.cc/").post("/proxy").reply(200, require(`../test/fixtures/client/wallet.json`));
