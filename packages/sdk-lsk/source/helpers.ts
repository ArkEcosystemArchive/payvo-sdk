...
export const isMultiSignatureRegistration = ({ assetID, moduleID }: Record<string, any>): boolean => moduleID === 4 && assetID === 0;

export const isDelegateRegistration = ({ assetID, moduleID }: Record<string, any>): boolean => moduleID === 5 && assetID === 0;
