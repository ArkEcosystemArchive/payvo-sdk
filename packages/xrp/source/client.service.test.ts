...
describe("ClientService", () => {
	...
	describe("#transactions", () => {
		it("should succeed", async () => {
			nock(/.+/).post("/").reply(200, require(`../test/fixtures/client/transactions.json`));
	...
	describe("#wallet", () => {
		it("should succeed", async () => {
			nock(/.+/).post("/").reply(200, require(`../test/fixtures/client/wallet.json`));
	...
	describe("#broadcast", () => {
		...
		it("should pass", async () => {
			nock(/.+/).post("/").reply(200, require(`../test/fixtures/client/broadcast.json`));
		...
		it("should fail", async () => {
			nock(/.+/).post("/").reply(200, require(`../test/fixtures/client/broadcast-failure.json`));
