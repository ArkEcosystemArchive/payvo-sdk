...
describeWithContext(
	"NetworkRepository",
	{
		...
		hosts: [
		  { host: 'https://ark-live.payvo.com/api', type: 'full' },
		  { host: 'https://ark-live-musig.payvo.com', type: 'musig' },
	...
	({ beforeEach, assert, it }) => {
		beforeEach((context) => {
			...
			context.subject = new NetworkRepository(new Profile({ avatar: "avatar", data: "", id: "uuid", name: "name" }));
		});
