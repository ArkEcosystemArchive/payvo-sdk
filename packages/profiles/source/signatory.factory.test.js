...
describe("SignatoryFactory", () => {
	...
	describe("when encryption password is provided", () => {
		test("returns signatory when wallet acts with mnemonic", async () => {
		...
		test("returns signatory when wallet and acts with mnemonic and has 2nd signature", async () => {
		...
		test("returns signatory when wallet acts with secret", async () => {
		...
		test("returns signatory when wallet acts with secret and has 2nd signature", async () => {
			const wallet = await profile.walletFactory().fromSecret({
				coin: "ARK",
				network: "ark.devnet",
				password: "password",
