		...
		return yup
			.object({
				...
				data: yup
					...
					.required(),
				exchangeTransactions: yup.lazy((entity) =>
					createDynamicSchema(
						entity,
						yup.string().uuid(),
						yup.object({
				...
				settings: yup
					.object({
						...
						[ProfileSetting.MarketProvider]: yup
							.string()
							.oneOf(["coincap", "cryptocompare", "coingecko"])
							.required(),
