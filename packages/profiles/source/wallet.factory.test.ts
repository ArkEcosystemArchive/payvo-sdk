...
describe("#fromMnemonicWithBIP39", () => {
    ...
    it("should create a wallet using BIP39 with encryption", async () => {
        ...
        assert.is(wallet.address(), "D6i8P5N44rFto6M6RALyUXLLs7Q1A1WREW");
        assert.is(wallet.publicKey(), "030fde54605c5d53436217a2849d276376d0b0f12c71219cd62b0a4539e1e75acd");
        assert.is(wallet.data().get(WalletData.EncryptedSigningKey)), "string");

    assert.is(PBKDF2.decrypt(wallet.data().get(WalletData.EncryptedSigningKey)!, "password"),
