...
beforeEach(async () => {
	...
	nock("http://51.75.183.27:3100", { encodedQueryParams: true })
		.post(
			"/",
		...
		.reply(200, require("../test/fixtures/coins/ada/testnet/transactions-1.json"))
		.post(
			"/",
		...
		.reply(200, require("../test/fixtures/coins/ada/testnet/transactions-2.json"))
		.post(
			"/",
			`{"query":"\\n\\t\\t\\t{\\n\\t\\t\\t\\tutxos_aggregate(\\n\\t\\t\\t\\t\\twhere: {\\n\\t\\t\\t\\t\\t\\taddress: {\\n\\t\\t\\t\\t\\t\\t\\t_in: [\\n\\t\\t\\t\\t\\t\\t\\t\\t\\"addr_test1qqy6nhfyks7wdu3dudslys37v252w2nwhv0fw2nfawemmn8k8ttq8f3gag0h89aepvx3xf69g0l9pf80tqv7cve0l33sw96paj\\"\\n\\"addr_test1qrhvwtn8sa3duzkm93v5kjjxlv5lvg67j530wyeumngu23lk8ttq8f3gag0h89aepvx3xf69g0l9pf80tqv7cve0l33s4s8xvh\\"\\n\\"addr_test1qrtlcnmfdyarpscqxa6nthjz0na7xyz3fa8vt3yjw2y5gs8k8ttq8f3gag0h89aepvx3xf69g0l9pf80tqv7cve0l33saf6px4\\"\\n\\"addr_test1qzawae46edstqpdy84hhymuldnflyup0kjrp9ss5mgzvgplk8ttq8f3gag0h89aepvx3xf69g0l9pf80tqv7cve0l33sfwe8sv\\"\\n\\"addr_test1qzfjfm724nv9qz6nfyagmj0j2uppr35gzv5qee8s7489wxlk8ttq8f3gag0h89aepvx3xf69g0l9pf80tqv7cve0l33scc4thv\\"\\n\\"addr_test1qzdcehzqelgwyzdzswc8f7743xvr3sywjq63s0auft8g0d8k8ttq8f3gag0h89aepvx3xf69g0l9pf80tqv7cve0l33sjv0ust\\"\\n\\"addr_test1qz2t57ujlkxdtv86pwehqq74a4t93xz60vvesnvgt3qz6g0k8ttq8f3gag0h89aepvx3xf69g0l9pf80tqv7cve0l33sp6hm22\\"\\n\\t\\t\\t\\t\\t\\t\\t]\\n\\t\\t\\t\\t\\t\\t}\\n\\t\\t\\t\\t\\t}\\n\\t\\t\\t\\t) {\\n\\t\\t\\t\\t\\taggregate {\\n\\t\\t\\t\\t\\t\\tsum {\\n\\t\\t\\t\\t\\t\\t\\tvalue\\n\\t\\t\\t\\t\\t\\t}\\n\\t\\t\\t\\t\\t}\\n\\t\\t\\t\\t}\\n\\t\\t\\t}"}`,
		)
		.reply(200, require("../test/fixtures/coins/ada/testnet/utxos_aggregate.json"))
		.persist();
});
...
describe("#fromMnemonicWithBIP39", () => {
	...
	it("should create a wallet using BIP39 with encryption", async () => {
		...
		expect(wallet.address()).toBe("D6i8P5N44rFto6M6RALyUXLLs7Q1A1WREW");
		expect(wallet.publicKey()).toBe("030fde54605c5d53436217a2849d276376d0b0f12c71219cd62b0a4539e1e75acd");
		expect(wallet.data().get(WalletData.EncryptedSigningKey)).toBeString();

		expect(PBKDF2.decrypt(wallet.data().get(WalletData.EncryptedSigningKey)!, "password")).toBe(
...
describe("#fromMnemonicWithBIP44", () => {
	describe("should create a wallet using BIP44 (mnemonic > address)", () => {
		...
		it("should work for BTC", async () => {
			...
			expect(wallet.address()).toBe("n16aeukbAKUZPh3iefK3DjpyJAc6TUHw9C");
		});
	});
...
describe("#fromMnemonicWithBIP49", () => {
	describe("should create a wallet using BIP49 (mnemonic > address)", () => {
		it("for BTC", async () => {
			...
			expect(wallet.address()).toBe("2NDqSnogr4eQeLrPWM5GmgBvNuMbwdyh1Bi");
		});
	});
...
describe("#fromMnemonicWithBIP84", () => {
	describe("should create a wallet using BIP84 (mnemonic > address)", () => {
		it("for BTC", async () => {
			...
			expect(wallet.address()).toBe("tb1quhtzwu2pm7apf4r0c4sgj73cvdrspy6ez4jxjn");
		});
	});
...
describe("#fromPublicKey", () => {
	...
	test("for BTC (testnet)", async () => {
		...
		expect(wallet.address()).toBe("mp2Ucb5WLX5v3aD3wmwbTi5xsbLESKhQDf");
		expect(wallet.publicKey()).toBe(
			"tpubDCdFvjrda9JXDYFb518YfcEEWSj3gRfRAU69PGnNS4dYx3bBARVhKQNRC1wBYComzGCyXea7rpYW2YjxahrEPzapLQpfSMky4bdz3YPTgTJ",
		);
	});
	...
	test("for BTC (livenet)", async () => {
		...
		expect(wallet.address()).toBe("12KRAVpawWmzWNnv9WbqqKRHuhs7nFiQro");
		expect(wallet.publicKey()).toBe(
			"xpub6Bk8X5Y1FN7pSecqoqkHe8F8gNaqMVApCrmMxZnRvSw4JpgqeM5T83Ze6uD4XEMiCSwZiwysnny8uQj5F6XAPF9FNKYNHTMoAu97bDXNtRe",
		);
	});
