...
describe("TransactionAggregate", () => {
	...
	it("should aggregate and filter transactions based on provided identifiers of type `address`", async () => {
		nock(/.+/)
			.get("/api/transactions")
			.query(true)
			.reply(200, require("../test/fixtures/client/transactions.json"));
	...
	it("should aggregate and filter transactions based on provided identifiers of type `extendedPublicKey`", async () => {
		nock(/.+/)
			.get("/api/transactions")
			.query(true)
			.reply(200, require("../test/fixtures/client/transactions.json"));
