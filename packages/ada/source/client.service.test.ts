...
describe("ClientService", () => {
	it("#wallet should succeed", async () => {
		nock(/.+/)
			.post("/")
			.reply(200, require(`../test/fixtures/client/transactions-0.json`))
			.post("/")
			.reply(200, require(`../test/fixtures/client/transactions-20.json`))
			.post("/")
			.reply(200, require(`../test/fixtures/client/utxos-aggregate.json`));
	...
	it("#transaction", async () => {
		nock(/.+/).post(/.*/).reply(200, require(`../test/fixtures/client/transaction.json`));
	...
	describe("#broadcast", () => {
		it("#accepted", async () => {
			nock(/.+/)
				.post("/")
				.reply(200, require(`../test/fixtures/transaction/transactions-page-1.json`))
				.post("/")
				.reply(200, require(`../test/fixtures/transaction/transactions-page-2.json`))
				.post("/")
				.reply(200, require(`../test/fixtures/transaction/utxos.json`))
				.post("/")
				.reply(200, require(`../test/fixtures/transaction/expiration.json`))
				.post("/")
				.reply(201, require(`../test/fixtures/transaction/submit-tx.json`));
		...
		it("#rejected", async () => {
			nock(/.+/).post("/").reply(201, require(`../test/fixtures/transaction/submit-tx-failed.json`));
