...
describe("ClientService", () => {
	...
	describe("#wallets", () => {
		it("should work with Core 2.0", async () => {
			...
			nock(/.+/)
				.get("/api/wallets")
				.query({ address: "DBk4cPYpqp7EBcvkstVDpyX7RQJNHxpMg8" })
				.reply(200, require(`../test/fixtures/client/wallets.json`));
	...
	describe("#delegate", () => {
		it("should succeed", async () => {
			nock(/.+/).get("/api/delegates/arkx").reply(200, require(`../test/fixtures/client/delegate.json`));
	...
	describe("#delegates", () => {
		it("should succeed", async () => {
			nock(/.+/).get("/api/delegates").reply(200, require(`../test/fixtures/client/delegates.json`));
	...
	describe("#votes", () => {
		...
		beforeEach(async () => {
			fixture = require(`../test/fixtures/client/wallet.json`);
		});
	...
	describe("#voters", () => {
		it("should succeed", async () => {
			nock(/.+/).get("/api/delegates/arkx/voters").reply(200, require(`../test/fixtures/client/voters.json`));
	...
	describe("#broadcast", () => {
		...
		beforeEach(async () => {
			fixture = require(`../test/fixtures/client/broadcast.json`);
		});
