...
describe("FeeService", () => {
    it("should get the fees for ARK", async () => {
        nock(/.+/)
            .get("/api/node/fees")
            .reply(200, require(`../test/fixtures/client/feesByNode.json`))
            .get("/api/transactions/fees")
            .reply(200, require(`../test/fixtures/client/feesByType.json`));
    ...
    it("should get the fees for BIND", async () => {
        nock(/.+/)
            .get("/api/node/fees")
            .reply(200, require(`../test/fixtures/client/feesByNode-bind.json`))
            .get("/api/transactions/fees")
            .reply(200, require(`../test/fixtures/client/feesByType-bind.json`));
