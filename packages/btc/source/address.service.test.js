...
test("should validate an address", async () => {
	...
	assert.true(await subject.validate(identity.addressBIP44));
	assert.true(await subject.validate(identity.addressBIP49));
	assert.true(await subject.validate(identity.addressBIP84));
