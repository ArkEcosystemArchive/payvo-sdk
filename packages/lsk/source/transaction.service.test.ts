...
beforeAll(async () => {
    ...
    nock(/.+/).get("/api/v2/fees").reply(200, require(`../test/fixtures/client/fees.json`)).persist();
    ...
    describe("#multiSignature", () => {
        ...
        it("should verify", async () => {
            ...
            nock(/.+/)
                ...
                .reply(200, require(`../test/fixtures/musig/lskp4agpmjwgw549xdrhgdt6dfwqrpvohgbkhyt8p.json`))
                ...
                .reply(200, require(`../test/fixtures/musig/lskn2de9mo9z3g9jvbpj4yjn84vrvjzcn5c5mon7a.json`))
                .persist();
