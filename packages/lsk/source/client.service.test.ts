...
describe("ClientService", () => {
	...
	describe("#wallet", () => {
		it("should succeed", async () => {
			nock(/.+/).get("/api/v2/accounts").query(true).reply(200, require(`../test/fixtures/client/wallet.json`));
	...
	describe("#wallets", () => {
		it("should succeed", async () => {
			nock(/.+/).get("/api/v2/accounts").query(true).reply(200, require(`../test/fixtures/client/wallets.json`));
	...
	describe("#delegate", () => {
		it("should succeed", async () => {
			nock(/.+/).get("/api/v2/accounts").query(true).reply(200, require(`../test/fixtures/client/delegate.json`));
	...
	describe("#delegates", () => {
		it("should succeed", async () => {
			nock(/.+/)
				.get("/api/v2/accounts")
				.query(true)
				.reply(200, require(`../test/fixtures/client/delegates.json`));
	...
	describe("#votes", () => {
		it("should succeed", async () => {
			nock(/.+/).get("/api/v2/votes_sent").query(true).reply(200, require(`../test/fixtures/client/votes.json`));
	...
	describe("#broadcast", () => {
		...
		it("should pass", async () => {
			nock(/.+/).post("/api/v2/transactions").reply(200, require(`../test/fixtures/client/broadcast.json`));
